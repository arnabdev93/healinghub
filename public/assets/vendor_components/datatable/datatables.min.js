...
! function(n) {
    ...
    function v(t, e, n, a) {
        ...
        if (void 0 !== a)
            ...
            for (; o < i; o++) t[e[o]] && r.push(t[e[o]][n]);
        return r
    }
    ...
    var C, U, e, t, $ = function(t, H) {
            ...
            return $.factory(t, H) ? $ : this instanceof $ ? V(t).DataTable(H) : (X = void 0 === (H = t), B = (W = this).length, X && (H = {}), this.api = function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) Z(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                        ...
                        for (g = T.length - 1; 0 <= g; g--) {
                            ...
                            for (Array.isArray(I) || (I = [I]), v = 0, b = I.length; v < b; v++) {
                                ...
                                if ("number" == typeof A && 0 <= A) {
                                    ...
                                    for (y = 0, D = C.length; y < D; y++) "_all" === A ? _(y, x) : -1 !== A.indexOf(":name") ? C[y].sName === A.replace(":name", "") && _(y, x) : M.forEach(function(t) {
                    ...
                    var L, F, N, j, P = o.children("tbody").find("tr").eq(0),
                        ...
                        O = function() {
                            ...
                            if (0 === e.length && (e = V("<tfoot/>").appendTo(o)), u.nTFoot = e[0], V("tr", e).addClass(c.tfoot.row), n.aaData)
        ...
        E = function(t, e) {
            if (Array.isArray(e))
                for (var n = 0; n < e.length; n++) E(t, e[n]);
            else t.push(e);
            return t
        };
            ...
            return V.isPlainObject(a) ? $.util.set(a._) : null === a ? function() {} : "function" == typeof a ? function(t, e, n) {
                ...
                for (var a, r, o, i, l = ft(n), n = l[l.length - 1], s = 0, u = l.length - 1; s < u; s++) {
                    ...
                    if (a = l[s].match(dt), r = l[s].match(p), a) {
                        if (l[s] = l[s].replace(dt, ""), t[l[s]] = [], (a = l.slice()).splice(0, s + 1), i = a.join("."), Array.isArray(e))
                            for (var c = 0, d = e.length; c < d; c++) f(o = {}, e[c], i), t[l[s]].push(o);
                        else t[l[s]] = e;
                        return
                    }
                ...
                if ("" !== n)
                    for (var i = ft(n), l = 0, s = i.length; l < s; l++) {
                        if (d = i[l].match(dt), a = i[l].match(p), d) {
                            if (i[l] = i[l].replace(dt, ""), "" !== i[l] && (t = t[i[l]]), r = [], i.splice(0, l + 1), o = i.join("."), Array.isArray(t))
                                for (var u = 0, c = t.length; u < c; u++) r.push(f(t[u], e, o));
    ...
    function nt(t) {
        ...
        if (e)
            for (var n = 0, a = e.length; n < a; n++) e[n] && z($.models.oSearch, e[n]);
    ...
    function W(t) {
        var e = t.aoHeader,
            ...
            a = 0;
        if (e.length)
            for (var r = 0, o = e[0].length; r < o; r++) n[r].bVisible && "none" !== V(e[0][r].cell).css("display") && a++;
        return a
    }
        ...
        if (i._aSortData = null, i._aFilterData = null, i.displayData = null, "dom" !== n && (n && "auto" !== n || "dom" !== i.src)) {
            ...
            if (l)
                if (void 0 !== a) ct(l[a], s[a]);
                    ...
                    for (r = 0, o = l.length; r < o; r++) ct(l[r], s[r])
    ...
    function Dt(t, e) {
        ...
        if (o) {
            if (("header" === e || f(t.aoColumns, i).join("")) && 1 === (n = (n = V("tr", o)).length ? n : V("<tr/>").appendTo(o)).length)
                for (var l = V("td, th", n).length, s = r.length; l < s; l++) V("<th/>").html(r[l][i] || "").appendTo(n);
            var u = It(t, o, !0);
    ...
    function S(t, e) {
        if (r = "ssp" == et(s = t), void 0 !== (i = s.iInitDisplayStart) && -1 !== i && (s._iDisplayStart = !r && i >= s.fnRecordsDisplay() ? 0 : i, s.iInitDisplayStart = -1), -1 !== tt(t, "aoPreDrawCallback", "preDraw", [t]).indexOf(!1)) w(t, !1);
        else {
            var l, n = [],
                a = 0,
                r = "ssp" == et(t),
    ...
    function Ct(e) {
        ...
        if (e.nTableWrapper = r[0], e.sDom)
            for (var o, i, l, s, u, c, d = e, t = e.sDom, f = r, h = t.match(/(".*?")|('.*?')|./g), p = 0; p < h.length; p++) o = null, "<" == (i = h[p]) ? (l = V("<div/>"), "'" != (s = h[p + 1])[0] && '"' != s[0] || (s = s.replace(/['"]/g, ""), u = "", -1 != s.indexOf(".") ? (c = s.split("."), u = c[0], c = c[1]) : "#" == s[0] ? u = s : c = s, l.attr("id", u.substring(1)).addClass(c), p++), f.append(l), f = l) : ">" == i ? f = f.parent() : "t" == i ? o = Wt(d) : $.ext.feature.forEach(function(t) {
    ...
    function Wt(t) {
        var e, n, a, r, o, i, l, s, u, c, d, f, h, p = V(t.nTable),
            g = t.oScroll;
    ...
    function Xt(e) {
        ...
        if (e.scrollBarVis !== f && void 0 !== e.scrollBarVis) e.scrollBarVis = f, M(e);
            ...
            if (e.scrollBarVis = f, u.children("thead, tfoot").remove(), (f = s.clone().prependTo(u)).find("th, td").removeAttr("tabindex"), f.find("[id]").removeAttr("id"), c && (m = c.clone().prependTo(u)).find("[id]").removeAttr("id"), e.aiDisplay.length)
                for (var h = u.children("tbody").eq(0).children("tr").eq(0).children("th, td").map(function(t) {
                        return {
                            idx: H(e, t),
    ...
    function $t(t) {
        ...
        if (t.oFeatures.bSort)
            for (Array.isArray(d) && Ut(t, h, d), f && d.pre && Ut(t, h, d.pre), Ut(t, h, t.aaSorting), f && d.post && Ut(t, h, d.post), e = 0; e < h.length; e++)
                if (c[l = h[e][0]])
                    for (n = 0, a = (r = c[l].aDataSort).length; n < a; n++) i = c[o = r[n]].sType || "string", void 0 === h[e]._idx && (h[e]._idx = c[o].asSorting.indexOf(h[e][1])), h[e][1] && s.push({
                        src: l,
                        col: o,
                        dir: h[e][1],
                        index: h[e]._idx,
    ...
    U = function(t, e) {
        ...
        function n(t) {
            ...
            var n, e, a, r = t ? t.nTable && t.oFeatures ? [t] : t.nodeName && "table" === t.nodeName.toLowerCase() ? -1 !== (r = a.indexOf(t)) ? [e[r]] : null : t && "function" == typeof t.settings ? t.settings().toArray() : ("string" == typeof t ? n = V(t).get() : t instanceof V && (n = t.get()), n ? e.filter(function(t, e) {
        ...
        iterator: function(t, e, n, a) {
            ...
            for ("string" == typeof t && (a = n, n = e, e = t, t = !1), o = 0, i = h.length; o < i; o++) {
                ...
                if ("table" === e) void 0 !== (r = n.call(g, h[o], o)) && f.push(r);
                    ...
                    for (c = this[o], "column-rows" === e && (u = he(h[o], p.opts)), l = 0, s = c.length; l < s; l++) d = c[l], void 0 !== (r = "cell" === e ? n.call(g, h[o], d.row, d.column, o, l) : n.call(g, h[o], d, o, l, u)) && f.push(r)
            }
        ...
        if (n.length && e && (e instanceof U || e.__dt_wrapper))
            for (var a, r = 0, o = n.length; r < o; r++) "__proto__" !== (a = n[r]).name && (e[a.name] = "function" === a.type ? function(e, n, a) {
                return function() {
    ...
    function oe(t, e, n, a, r) {
        for (var o, i, l, s, u = [], c = typeof e, d = 0, f = (e = e && "string" != c && "function" != c && void 0 !== e.length ? e : [e]).length; d < f; d++)
            for (l = 0, s = (i = e[d] && e[d].split && !e[d].match(/[[(:]/) ? e[d].split(",") : [e[d]]).length; l < s; l++)(o = (o = n("string" == typeof i[l] ? i[l].trim() : i[l])).filter(function(t) {
                return null != t
    ...
    function se(o, i, t, e) {
        function l(t, e) {
            ...
            else t.nodeName && "tr" === t.nodeName.toLowerCase() ? (t.setAttribute("data-dt-row", i.idx), s.push(t)) : (n = V("<tr><td></td></tr>").attr("data-dt-row", i.idx).addClass(e), V("td", n).addClass(e).html(t)[0].colSpan = W(o), s.push(n[0]))
        }
        var s = [];
    ...
    var he = function(t, e) {
            ...
            if ("current" == e)
                ...
                for (u = 0, c = t.aoData.length; u < c; u++) t.aoData[u] && ("none" == i || -1 === (n = r.indexOf(u)) && "removed" == i || 0 <= n && "applied" == i) && a.push(u);
        ...
        be = (e("columns()", function(n, a) {
            ...
            var e = this,
                ...
                t = this.iterator("column", function(t, e) {
                    ...
                    ! function(t, e, n) {
                        ...
                        if (n)
                            for (var s = f(o, "bVisible").indexOf(!0, e + 1), u = 0, c = l.length; u < c; u++) l[u] && (r = l[u].nTr, a = l[u].anCells, r) && r.insertBefore(a[e], a[s] || null);
            ...
            return void 0 === e ? 0 !== n.length ? n[0].aaSorting : void 0 : ("number" == typeof e ? e = [
                [e, t]
            ] : 1 < a.length && (e = a), this.iterator("table", function(t) {
            ...
            for (var n, a, r = (e || $.version).split("."), o = t.split("."), i = 0, l = o.length; i < l; i++)
            ...
            return c = c || !1, this.iterator("table", function(t) {
                var e = t.oClasses,
                    ...
                    u = c ? "remove" : "detach",
                    a = (i[u](), l[u](), !c && o && (o.insertBefore(n, r), i.css("width", t.sDestroyWidth).removeClass(e.table)), $.settings.indexOf(t)); - 1 !== a && $.settings.splice(a, 1)
            })
    ...
    return $.feature.register("pageLength", function(a, t) {
        ...
        if (Array.isArray(r[0])) o = r[0], i = r[1];
            ...
            for (p = 0; p < r.length; p++) V.isPlainObject(r[p]) ? (o.push(r[p].value), i.push(r[p].label)) : (o.push(r[p]), i.push(r[p]));
