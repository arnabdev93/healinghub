					...
					<div class="col-lg-5 col-md-5 col-12">
						...
						<div class="bg-white rounded10 shadow-lg">
							...
							<div class="content-top-agile p-20 pb-0">
								...
								<p class="mb-0 text-fade">Sign in to continue to {{ config('app.name') }} Admin.</p>							
							...
							<div class="p-40">
									...
									<div class="row">
										...
										<!-- <div class="col-6">
										 ...
										 <div class="fog-pwd text-end">
											...
											<a href="javascript:void(0)" class="text-primary fw-500 hover-primary"><i class="ion ion-locked"></i> Forgot password?</a><br>
								...
								<div class="text-center">
									...
									<p class="mt-15 mb-0 text-fade">Don't have an account? <a href="{{ route('register') }}" class="text-primary ms-5">Sign Up</a></p>
