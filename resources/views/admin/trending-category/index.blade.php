   ...
   <div class="content-header">
      <div class="d-flex align-items-center">
         <div class="me-auto healbreadcrumb">
            <h4 class="page-title">Trending Categories</h4>
            <div class="d-inline-block align-items-center">
               <nav>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="{{route('home')}}"><i class="mdi mdi-home-outline"></i></a></li>
                     <li class="breadcrumb-item active" aria-current="page">Trending Categories</li>
                  </ol>
               </nav>
            </div>
         </div>
                 ...
                 <div class="card-body">
                     <div class="row mb-2">
                        <div class="col-xl-12">
                           <div class="text-xl-end mt-xl-0 mt-2">
                              <a href="{{route('trending-categories.create')}}" class="btn btn-sm btn-primary-light mb-2">Create</a>
                           </div>
                        </div><!-- end col-->
                     </div>
                     <div class="table-responsive rounded card-table">
                        <div class="row mb-3">
                           ...
                           <div class="col-md-3">
                              <label class="form-label"><strong>Filter by Category Name</strong></label>
