   ...
   <div class="content-header">
      <div class="d-flex align-items-center">
         <div class="me-auto healbreadcrumb">
            <h4 class="page-title">Create {{ucfirst($type)}}</h4>
                 ...
                 <div class="row">
                     ...
                     <div class="col-md-4"> 
                        <div class="form-group  @error('mobile') error @endif">
                           ...
                           <div class="controls">
                              <input type="text" name="mobile" class="form-control" value="{{old('mobile')}}" @error('mobile') aria-invalid="true" @endif> 
                     ...
                     <div class="col-md-4"> 
                        <div class="form-group  @error('email') error @endif">
                           ...
                           <div class="controls">
                              <input type="text" name="email" class="form-control" value="{{old('email')}}" @error('email') aria-invalid="true" @endif> 
                     ...
                     <div class="col-md-4"> 
                        <div class="form-group  @error('consult_fee_phone') error @endif">
                           ...
                           <div class="controls">
                              <input type="text" name="consult_fee_phone" class="form-control" value="{{old('consult_fee_phone')}}" @error('consult_fee_phone') aria-invalid="true" @endif oninput="this.value = this.value.replace(/[^0-9.]/g, '')" onpaste="this.value = this.value.replace(/[^0-9.]/g, ''); return false;"> 
                     ...
                     <div class="col-md-4"> 
                        <div class="form-group  @error('consult_fee_vdo') error @endif">
                           ...
                           <div class="controls">
                              <input type="text" name="consult_fee_vdo" class="form-control" value="{{old('consult_fee_vdo')}}" @error('consult_fee_vdo') aria-invalid="true" @endif oninput="this.value = this.value.replace(/[^0-9.]/g, '')" onpaste="this.value = this.value.replace(/[^0-9.]/g, ''); return false;"> 
                     ...
                     <div class="col-md-4"> 
                        <div class="form-group  @error('specialist') error @endif">
                           ...
                           <div class="controls">
                              <input type="text" name="specialist" class="form-control" value="{{old('specialist')}}" @error('specialist') aria-invalid="true" @endif> 
                     ...
                     <div class="col-md-4"> 
                        <div class="form-group  @error('bank_name') error @endif">
                           ...
                           <div class="controls">
                              <input type="text" name="bank_name" class="form-control" value="{{old('bank_name')}}" @error('bank_name') aria-invalid="true" @endif> 
                     ...
                     <div class="col-md-4"> 
                        <div class="form-group  @error('bank_acc_no') error @endif">
                           ...
                           <div class="controls">
                              <input type="text" name="bank_acc_no" class="form-control" value="{{old('bank_acc_no')}}" @error('bank_acc_no') aria-invalid="true" @endif> 
                     ...
                     <div class="col-md-4"> 
                        <div class="form-group  @error('bank_ifsc_code') error @endif">
                           ...
                           <div class="controls">
                              <input type="text" name="bank_ifsc_code" class="form-control" value="{{old('bank_ifsc_code')}}" @error('bank_ifsc_code') aria-invalid="true" @endif> 
                     ...
                     <div class="col-md-4"> 
                        <div class="form-group  @error('upi') error @endif">
                           ...
                           <div class="controls">
                              <input type="text" name="upi" class="form-control" value="{{old('upi')}}" @error('upi') aria-invalid="true" @endif> 
                     ...
                     <div class="col-md-12"> 
                        <div class="form-group  @error('about') error @endif">
                           ...
                           <div class="controls">
                              <textarea name="about" class="form-control" @error('about') aria-invalid="true" @endif>{{old('about')}}</textarea>
