                 ...
                 <div class="box-body">
                     <div class="row">
                         ...
                         <div class="col-md-8 col-sm-6">
                               ...
                               <section class="pay_related {{ in_array($order->status, ['pending', 'reject']) ? 'd-none' : '' }}">
                                    <div class="mt-4">
                                        <h6 class="fs-15">Pay Status:</h6>
                                        <p class="text-fade">
                                            <span class="badge badge-sm badge-success-light fw-bold text-capitalize">{{ $order->pay_status }}</span>
                                        </p>
                                    </div>
                                    <div class="col-md-4">
                                 ...
                                 <div class="mt-4">
                                    @if(isset($appointment) && $appointment)
                                       <hr>
                                       <div class="mt-3">
                                          <h5>Doctor Appointment Details</h5>
                                          <div class="d-flex gap-2">
                                             <p class="fs-12">
                                             <strong>Apointment Number:</strong>
                                             {{$appointment->appointment_no}}
                                             </p>
                                             <a class="btn btn-sm btn-info" href="{{route('appointments.show',$appointment->id)}}">Details</a>
                                          </div>
                                          <p class="fs-12">
                                          ...
                                          <p class="fs-12">
                                             ...
                                             {{ ($appointment->appointment_type === 'audio') ? 'Audio call' : 'Video call'  }}
                                          </p>
                                          <p class="fs-12">
...
//   }
    ...
    $('#status_changes').on('change', function () {
        ...
        $.ajax({
            url: "{{ url('prescription/delivery-status') }}/" + orderId,
            type: 'POST',
            data: {
                _token: "{{ csrf_token() }}",
