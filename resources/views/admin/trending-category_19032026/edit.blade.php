   ...
   <div class="content-header">
      <div class="d-flex align-items-center">
         <div class="me-auto healbreadcrumb">
            <h4 class="page-title">Update Trending Category</h4>
       ...
       <!-- Basic Forms -->
        <div class="box">
         ...
         <div class="box-body">
           <div class="row">
            <div class="col">
               <form role="form" action="{{ route('trending-categories.update',$category->id) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                 <div class="row">
                     <div class="col-md-6"> 
                        <div class="form-group  @error('name') error @endif">
                           ...
                           <div class="controls">
                              <input type="text" name="name" class="form-control" value="{{old('name',$category->name)}}" @error('name') aria-invalid="true" @endif> 
                     ...
                     <div class="col-md-6">                
                        <div class="form-group @error('image') error @endif">
                           ...
                           <div class="controls">
                              ...
                              <img src="{{$category->image_path}}" height="50" width="50" class="preview">
                           </div>
                        </div>
                     </div>
                  </div>
