    ...
    public function index(Request $request)
    {
        if (request()->ajax()) {
            ...
            if ($request->filled('category_id')) {
                $listQry->where('id', $request->category_id);
            }

            if ($request->filled('start_date') && $request->filled('end_date')) {
                $listQry->whereBetween('created_at', [
        ...
        $categories = TrendingCategory::orderBy('name', 'ASC')->get();
        ...
        $dataTable = $builder->columns([
            ...
            'image' => [
                'data' => 'image',
                'name' => 'trending_categories.image',
                'title' => 'Image',
                'searchable' => false
            ],
            ...
            'name' => [
                'data' => 'name',
                'name' => 'trending_categories.name',
                'title' => 'Name'
            ],

            'status' => [
                'data' => 'status',
                'name' => 'trending_categories.status',
                'title' => 'Status'
            ],

            'created_at' => [
                'data' => 'created_at',
                'name' => 'trending_categories.created_at',
                'title' => 'CreatedAt'
            ],
        ...
        return view('admin.trending-category.index',compact('dataTable', 'categories'));
    }
